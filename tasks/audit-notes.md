...
|---|---|---|---|
| 8–13 | "internal `git.example.com/.../shared/*` packages and the in-repo `service/pkg/*` utilities" | Keep, but make explicit that this is **backend_core delta**, not just any corp Go project | US-003 |
...
| 419 | `git.example-c.invalid/processing/new-cryptoprocessing/pkg/logger` | Real path: `git.example.com/Fri_releases/cryptoprocessing/shared/logger`. Old path is leftover. | US-006 |
| 585 | `gl.example-d.invalid/cryptoprocessing/pkg/healthcheck` | Real: `git.example.com/Fri_releases/cryptoprocessing/shared/healthcheck`. | US-006 |
| 639 | `git.example-c.invalid/processing/new-cryptoprocessing/pkg/events/v2` | Real: `git.example.com/Fri_releases/cryptoprocessing/shared/events/v2`. | US-006 |
| 752 | `git.example-c.invalid/processing/new-cryptoprocessing/pkg/pagination` | Real: `git.example.com/Fri_releases/cryptoprocessing/shared/pagination`. | US-006 |
...
| `kafka.md:313, 654, 660+` | outbox table integration | **Generic concept** — keep. The implementation example is library-agnostic. Verify no `git.example.com/...shared/outbox` import. |
