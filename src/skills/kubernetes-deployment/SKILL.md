...
description: Create and manage Kubernetes manifests (Deployment, Service, ConfigMap, Secret, Ingress), Helm charts, validate configurations with kubectl dry-run. Use when user mentions Kubernetes, K8s, kubectl, Helm, deployments, services, pods, cluster configuration, or asks to deploy to Kubernetes.
